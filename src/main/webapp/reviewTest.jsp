...
try {
	...
	while (rs1.next()) {
		...
		testResult = rs1.getString("Value");
	}
	...
	if (test.toLowerCase().equals("rbs"))
	{
		test  = "2-h post glucose load test";
	}
					...
					<div class="card-body">
						...
						<div class="row">
							<div class="offset-lg-1 col-lg-9">
								<div class="p-5">
									<form class="user" action="reviewTest" method="post">
										...
										<div class="form-group">
											<div class="col-md-12 row">
												...
												<div class="col-md-6"><%=testResult%></div>
											</div>
