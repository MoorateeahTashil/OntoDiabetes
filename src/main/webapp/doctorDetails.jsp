					...
					<div class="card-body">
						...
						<div class="row">
							<div class="offset-lg-1 col-lg-9">
								<div class="p-5">
									<form class="user" action="doctorDetails" method="post">
										...
										<div class="form-group">
											<input class="form-control form-control-user" id="reg"
												name="reg" placeholder="Registration Number">
										</div>

										<div class="form-group">
											<input class="form-control form-control-user" id="dobTextBox"
												name="dobTextBox" type="date" placeholder="Praticing From"
												required>
										</div>
										...
										<div class="form-group">
											<input type="text" class="form-control form-control-user"
												id="prof" name="prof" placeholder="Professional Statement"
												required>
										</div>
