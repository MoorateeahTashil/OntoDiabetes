...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Nav Item - Dashboard -->
			<li
				class="nav-item <%if (request.getRequestURL().toString().contains("dashboard")) {%>active<%}%>"><a
			...
			<!-- Nav Item - Charts -->
			<li
				class="nav-item <%if (request.getRequestURL().toString().contains("symptoms")) {%>active<%}%>"><a
				class="nav-link " href="symptoms.jsp"> <i
					class="fa fa-stethoscope"></i> <span>Symptoms</span>
			</a></li>
